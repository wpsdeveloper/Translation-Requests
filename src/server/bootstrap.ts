...
function dev_bootstrap_properties() {
  const props = {
   "APPSHEET_APP_ID": "91a940b5-eb26-40ad-bb32-0b17fde4fd39",
   "APPSHEET_ACCESS_KEY": "V2-ioFEK-BVXmK-tg94D-i0iT8-uK2FM-xvsSM-PPVt4-PIMF4",
   "FORM_SPREADSHEET_ID": "1aA8fmn-GEcXQzT7HyB77taIaIO8pfRDu8UW1WQIXdDc",
   "NOTIFICATION_TEST_EMAIL": "wpsdeveloper@walpole.k12.ma.us",
   "DEV_MODE": "true"
};
